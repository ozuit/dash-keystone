<?php
	$sql = "select * from baiviet, loaitin where baiviet.idloaitin = loaitin.idloaitin and loaitin.idloaitin = '$dong_loaitin[idloaitin]' order by idbaiviet desc limit 2,6 ";
	$baiviet = mysql_query($sql);
?>

<div class="box no-padding no-border" style="margin-top:10px;">
	<div class="tieudebox">
    	<?php echo $dong_loaitin["tenloaitin"]?>
    </div>
